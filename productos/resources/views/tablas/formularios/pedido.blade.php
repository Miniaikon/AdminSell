<div class="form-group">
	...
	<div class="caja"><select id="pedId" name="nombre_producto" placeholder="Seleccione un producto" class="form-control form-black" tabindex="2">
...
<div class="form-group">
	...
	{!!Form::number('cantidad', null, ['class'=>'form-control form-black', 'placeholder'=>'Cantidad', 'id'=>'cantidades'])!!}
</div>
<div class="form-group">
